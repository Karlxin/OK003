	...
	Mat<double> X, Mat<double> y, double lambda, Mat<uint32_t> Theta_indicator)
{
	...
	int32_t RATIO = 100;// maximum allowed slope ratio
	...
	J_grad_pair_1 = nnCostFunction_pair_n(nn_params, layer_size, X, y,
	...
	while (i < abs(length))//while not finished
	{
		...
		J_grad_pair_2 = nnCostFunction_pair_n(nn_params, layer_size, X, y,
